	...
	<div class="row">
		<div class="col-md-6">
			...
			<div class="box box-top-image maps">
				<h3><?php esc_html_e( 'Tour Operator Essentials Bundle', 'tour-operator' ); ?> - <span class="price">from $0.00 per yearly license</span></h3>
		...
		<div class="col-md-6">
			...
			<div class="box box-top-image specials">
				<h3><?php esc_html_e( 'Tour Operator Complete Bundle', 'tour-operator' ); ?> - <span class="price">from $0.00 per yearly license</span></h3>
