		...
		if ( false != $widget_text ) {
            ...
            <div class="textwidget">
                <div class="lsx-full-width-alt"
                     style="<?php echo wp_kses_post( $styletag ); ?>">
	...
	function form( $instance ) {
        ...
        <p>
            ...
            <input class="widefat"
                   ...
                   name="<?php echo wp_kses_post( $this->get_field_name( 'title' ) ); ?>"
                   type="text"
                   value="<?php echo wp_kses_post( $title ); ?>"/>
        </p>
        <p>
            <label for="<?php echo wp_kses_post( $this->get_field_id( 'text' ) ); ?>"><?php esc_html_e( 'Content:' ); ?></label>
            <textarea class="widefat" rows="16" cols="20"
                      id="<?php echo wp_kses_post( $this->get_field_id( 'text' ) ); ?>"
                      name="<?php echo wp_kses_post( $this->get_field_name( 'text' ) ); ?>"><?php echo esc_textarea( $text ); ?></textarea>
        </p>
        <p>
            <label for="<?php echo wp_kses_post( $this->get_field_id( 'image' ) ); ?>"><?php esc_html_e( 'Background Image:', 'tour-operator' ); ?></label>
            <input class="widefat"
                   id="<?php echo wp_kses_post( $this->get_field_id( 'image' ) ); ?>"
                   name="<?php echo wp_kses_post( $this->get_field_name( 'image' ) ); ?>"
                   type="text"
                   value="<?php echo wp_kses_post( $image ); ?>"/>
            <input class="upload_image_button button button-primary"
        ...
        <p>
            ...
            <input class="widefat"
                   id="<?php echo wp_kses_post( $this->get_field_id( 'class' ) ); ?>"
                   name="<?php echo wp_kses_post( $this->get_field_name( 'class' ) ); ?>"
                   type="text"
                   value="<?php echo wp_kses_post( $class ); ?>"/>
            <small>Add your own class to the opening element of the widget
            </small>
        </p>

        <h4 class="widget-title"
            style="border-top: 1px solid #e5e5e5;padding-top:10px;"><?php esc_html_e( 'Background CSS', 'lsx-framework' ); ?></h4>
        <p>
            <label for="<?php echo wp_kses_post( $this->get_field_id( 'color' ) ); ?>"><?php esc_html_e( 'Colour:', 'tour-operator' ); ?></label>
            <input class="widefat"
                   id="<?php echo wp_kses_post( $this->get_field_id( 'color' ) ); ?>"
                   name="<?php echo wp_kses_post( $this->get_field_name( 'color' ) ); ?>"
                   type="text"
        ...
        <p>
            ...
            <input class="widefat"
                   id="<?php echo wp_kses_post( $this->get_field_id( 'pos_x' ) ); ?>"
                   name="<?php echo wp_kses_post( $this->get_field_name( 'pos_x' ) ); ?>"
                   type="text"
                   value="<?php echo wp_kses_post( $pos_x ); ?>"/>
        </p>
        <p>
            <label for="<?php echo wp_kses_post( $this->get_field_id( 'pos_y' ) ); ?>"><?php esc_html_e( 'Position Y:', 'tour-operator' ); ?></label>
            <input class="widefat"
                   id="<?php echo wp_kses_post( $this->get_field_id( 'pos_y' ) ); ?>"
                   name="<?php echo wp_kses_post( $this->get_field_name( 'pos_y' ) ); ?>"
                   type="text"
                   value="<?php echo wp_kses_post( $pos_y ); ?>"/>
        </p>
        <p>
            <label for="<?php echo wp_kses_post( $this->get_field_id( 'size' ) ); ?>"><?php esc_html_e( 'Size:', 'tour-operator' ); ?></label>
            <select name="<?php echo wp_kses_post( $this->get_field_name( 'size' ) ); ?>"
                    id="<?php echo wp_kses_post( $this->get_field_id( 'size' ) ); ?>"
                    class="widefat">
				<?php
				$options = array(
					'Contain' => 'contain',
        ...
        <p>
            <label for="<?php echo wp_kses_post( $this->get_field_id( 'repeat' ) ); ?>"><?php esc_html_e( 'Repeat:', 'tour-operator' ); ?></label>
            <select name="<?php echo wp_kses_post( $this->get_field_name( 'repeat' ) ); ?>"
                    id="<?php echo wp_kses_post( $this->get_field_id( 'repeat' ) ); ?>"
                    class="widefat">
				<?php
				$options = array(
					'No Repeat' => 'no-repeat',
