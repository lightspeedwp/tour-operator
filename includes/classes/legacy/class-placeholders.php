	...
	public function display_settings( $tab = false ) {
		...
		if ( class_exists( 'LSX_Banners' ) ) { ?>
            <tr class="form-field banner-placeholder-wrap">
                ...
                <td>
                    <input class="input_image_id" type="hidden" {{#if
                           banner_placeholder_id}}
                           value="{{banner_placeholder_id}}" {{/if}}
                    name="banner_placeholder_id" />
                    <input class="input_image" type="hidden" {{#if
                           banner_placeholder}} value="{{banner_placeholder}}"
                           {{/if}} name="banner_placeholder" />
                    <div class="thumbnail-preview">
                        {{#if banner_placeholder}}<img
                                src="{{banner_placeholder}}" width="150"/>{{/if}}
                    </div>
                    <a {{#if banner_placeholder}}style="display:none;" {{/if}}
                    class="button-secondary
                    lsx-thumbnail-image-add"><?php esc_html_e( 'Choose Image', 'tour-operator' ); ?></a>
                    <a {{#unless banner_placeholder}}style="display:none;" {{/unless}}
                    class="button-secondary
                    lsx-thumbnail-image-delete"><?php esc_html_e( 'Delete', 'tour-operator' ); ?></a>
                </td>
            </tr>
		<?php } ?>
        <tr class="form-field">
            ...
            <td>
                <input class="input_image_id" type="hidden" {{#if
                       ...
                       value="{{default_placeholder_id}}" {{/if}}
                name="default_placeholder_id" />
                <input class="input_image" type="hidden" {{#if
                       default_placeholder}} value="{{default_placeholder}}" {{/if}}
                name="default_placeholder" />
                <div class="thumbnail-preview">
                    {{#if default_placeholder}}<img
                            src="{{default_placeholder}}" width="150"/>{{/if}}
                </div>
                <a {{#if default_placeholder}}style="display:none;" {{/if}}
                class="button-secondary
                lsx-thumbnail-image-add"><?php esc_html_e( 'Choose Image', 'tour-operator' ); ?></a>
                <a {{#unless default_placeholder}}style="display:none;" {{/unless}}
                class="button-secondary
                lsx-thumbnail-image-delete"><?php esc_html_e( 'Delete', 'tour-operator' ); ?></a>
            </td>
        </tr>
        ...
        <tr class="form-field">
            ...
            <td>
                <input class="input_image_id" type="hidden" {{#if
                       posts_placeholder_id}} value="{{posts_placeholder_id}}"
                       {{/if}} name="posts_placeholder_id" />
                <input class="input_image" type="hidden" {{#if
                       posts_placeholder}} value="{{posts_placeholder}}" {{/if}}
                name="posts_placeholder" />
                <div class="thumbnail-preview">
                    {{#if posts_placeholder}}<img src="{{posts_placeholder}}"
                                                  width="150"/>{{/if}}
                </div>
                <a {{#if posts_placeholder}}style="display:none;" {{/if}}
                class="button-secondary
                lsx-thumbnail-image-add"><?php esc_html_e( 'Choose Image', 'tour-operator' ); ?></a>
                <a {{#unless posts_placeholder}}style="display:none;" {{/unless}}
                class="button-secondary
                lsx-thumbnail-image-delete"><?php esc_html_e( 'Delete', 'tour-operator' ); ?></a>
            </td>
        </tr>
        ...
        <tr class="form-field">
            ...
            <td>
                <input type="checkbox" {{#if disable_blog_placeholder}}
                       checked="checked" {{/if}} name="disable_blog_placeholder"
                />
        ...
        <tr class="form-field featured-placeholder-wrap">
            ...
            <td>
                <input class="input_image_id" type="hidden" {{#if
                       ...
                       value="{{featured_placeholder_id}}" {{/if}}
                name="featured_placeholder_id" />
                <input class="input_image" type="hidden" {{#if
                       featured_placeholder}} value="{{featured_placeholder}}"
                       {{/if}} name="featured_placeholder" />
                <div class="thumbnail-preview">
                    {{#if featured_placeholder}}<img
                            src="{{featured_placeholder}}" width="150"/>{{/if}}
                </div>
                <a {{#if featured_placeholder}}style="display:none;" {{/if}}
                class="button-secondary
                lsx-thumbnail-image-add"><?php esc_html_e( 'Choose Image', 'tour-operator' ); ?></a>
                <a {{#unless featured_placeholder}}style="display:none;" {{/unless}}
                class="button-secondary
                lsx-thumbnail-image-delete"><?php esc_html_e( 'Delete', 'tour-operator' ); ?></a>
            </td>
        </tr>
