...
function lsx_to_accommodation_single_content_bottom() {
	if ( is_singular( 'accommodation' ) ) {
		if ( function_exists( 'lsx_to_has_map' ) && lsx_to_has_map() ) { ?>
			<section id="accommodation-map" class="lsx-to-section lsx-to-collapse-section">
				<h2 class="lsx-to-section-title lsx-to-collapse-title lsx-title hidden-lg" data-toggle="collapse" data-target="#collapse-accommodation-map"><?php esc_html_e( 'Map', 'tour-operator' ); ?></h2>
		...
		lsx_to_accommodation_facilities( '<section id="facilities" class="lsx-to-section lsx-to-collapse-section"><h2 class="lsx-to-section-title lsx-to-collapse-title lsx-title" data-toggle="collapse" data-target="#collapse-facilities">' . esc_html__( 'Facilities', 'tour-operator' ) . '</h2><div id="collapse-facilities" class="collapse in"><div class="collapse-inner"><div class="row facilities-wrapper">', '</div></div></div></section>' );

		lsx_to_included_block();

		lsx_to_gallery( '<section id="gallery" class="lsx-to-section lsx-to-collapse-section"><h2 class="lsx-to-section-title lsx-to-collapse-title lsx-title" data-toggle="collapse" data-target="#collapse-gallery">' . esc_html__( 'Gallery', 'tour-operator' ) . '</h2><div id="collapse-gallery" class="collapse in"><div class="collapse-inner">', '</div></div></section>' );

		if ( function_exists( 'lsx_to_videos' ) ) {
			lsx_to_videos( '<section id="videos" class="lsx-to-section lsx-to-collapse-section"><h2 class="lsx-to-section-title lsx-to-collapse-title lsx-title" data-toggle="collapse" data-target="#collapse-videos">' . esc_html__( 'Videos', 'tour-operator' ) . '</h2><div id="collapse-videos" class="collapse in"><div class="collapse-inner">', '</div></div></section>' );
		} elseif ( class_exists( 'Envira_Videos' ) ) {
			lsx_to_envira_videos( '<section id="videos" class="lsx-to-section lsx-to-collapse-section"><h2 class="lsx-to-section-title lsx-to-collapse-title lsx-title" data-toggle="collapse" data-target="#collapse-videos">' . esc_html__( 'Videos', 'tour-operator' ) . '</h2><div id="collapse-videos" class="collapse in"><div class="collapse-inner">', '</div></div></section>' );
		}
		...
		lsx_to_related_items( 'travel-style', '<section id="related-items" class="lsx-to-section lsx-to-collapse-section"><h2 class="lsx-to-section-title lsx-to-collapse-title lsx-title" data-toggle="collapse" data-target="#collapse-related-items">' . lsx_to_get_post_type_section_title( 'accommodation', 'similar', 'Related Accommodation' ) . '</h2><div id="collapse-related-items" class="collapse in"><div class="collapse-inner">', '</div></div></section>' );
		...
		if ( lsx_to_accommodation_display_connected_tours() && post_type_exists( 'tour' ) && is_array( $connected_tours ) && ! empty( $connected_tours ) ) {
			lsx_to_related_items( $connected_tours, '<section id="tours" class="lsx-to-section lsx-to-collapse-section"><h2 class="lsx-to-section-title lsx-to-collapse-title lsx-title" data-toggle="collapse" data-target="#collapse-related-items">' . esc_html__( 'Related Tours' , 'tour-operator' ) . '</h2><div id="collapse-related-items" class="collapse in"><div class="collapse-inner">', '</div></div></section>', true, 'tour' );
		}
...
function lsx_to_destination_single_content_bottom() {
	if ( is_singular( 'destination' ) ) {
		if ( function_exists( 'lsx_to_has_map' ) && lsx_to_has_map() ) { ?>
			<section id="destination-map" class="lsx-to-section lsx-to-collapse-section">
				<h2 class="lsx-to-section-title lsx-to-collapse-title lsx-title hidden-lg" data-toggle="collapse" data-target="#collapse-destination-map"><?php esc_html_e( 'Map', 'tour-operator' ); ?></h2>
...
function lsx_to_tour_single_content_bottom() {
	if ( is_singular( 'tour' ) ) {
		if ( function_exists( 'lsx_to_has_map' ) && lsx_to_has_map() ) { ?>
			<section id="tour-map" class="lsx-to-section lsx-to-collapse-section">
				<h2 class="lsx-to-section-title lsx-to-collapse-title lsx-title hidden-lg" data-toggle="collapse" data-target="#collapse-tour-map"><?php esc_html_e( 'Map', 'tour-operator' ); ?></h2>
		...
		if ( lsx_to_has_itinerary() ) { ?>
			<section id="itinerary" class="lsx-to-section lsx-to-collapse-section">
				<h2 class="lsx-to-section-title lsx-to-collapse-title lsx-title" data-toggle="collapse" data-target="#collapse-itinerary"><?php esc_html_e( 'Full Day by Day Itinerary', 'tour-operator' ); ?></h2>
		...
		lsx_to_related_items( 'travel-style', '<section id="related-items" class="lsx-to-section lsx-to-collapse-section"><h2 class="lsx-to-section-title lsx-to-collapse-title lsx-title" data-toggle="collapse" data-target="#collapse-related-items">' . lsx_to_get_post_type_section_title( 'tour', 'related', 'Related Tours' ) . '</h2><div id="collapse-related-items" class="collapse in"><div class="collapse-inner">', '</div></div></section>' );
