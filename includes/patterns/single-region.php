...
return array(
	...
	'description'   => __( 'Displays a single region page', 'tour-operator' ),
...
<!-- wp:query {"queryId":67,"query":{"perPage":2,"pages":0,"offset":0,"postType":"review","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false,"parents":[]},"align":"wide","className":"lsx-to-slider"} -->
