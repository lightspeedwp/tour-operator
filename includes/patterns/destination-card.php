...
return array(
	...
	'content'     => '
		<!-- wp:group {"metadata":{"categories":["lsx-tour-operator"],"patternName":"core/block/3163","name":"Custom Destination"},"className":"is-style-shadow-xsm","style":{"border":{"radius":"8px"}},"layout":{"type":"constrained"}} -->
		<div class="wp-block-group is-style-shadow-xsm" style="border-radius:8px"><!-- wp:cover {"useFeaturedImage":true,"dimRatio":0,"customOverlayColor":"#7097aa","isUserOverlayColor":true,"contentPosition":"bottom center","isDark":false,"metadata":{"name":"Custom Destination Card"},"style":{"spacing":{"padding":{"top":"0","bottom":"0","left":"0","right":"0"}},"border":{"radius":"8px"}},"layout":{"type":"constrained"}} -->
