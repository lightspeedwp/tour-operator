	...
	<table class="form-table">
		<tbody>
			<?php
				 ...
				 */
			?>			
			<?php do_action('lsx_framework_team_tab_content_top','team'); ?>
			<?php
				/* Hooked
				 ...
				 */
			?>			
			<?php do_action('lsx_framework_team_tab_content','team'); ?>			
		</tbody>
	</table>
	<?php do_action('lsx_framework_team_tab_bottom','team'); ?>	
</div>