 ...
 * @since 1.0.0
 */
function to_block_block_assets() { // phpcs:ignore
	...
	register_block_type(
		'tour-operator/to-content', array(
			...
			'editor_script' => 'to_block-block-js',
			// Enqueue blocks.editor.build.css in the editor only.
			'editor_style'  => 'to_block-block-editor-css',
		)
	);
	...
	function blocks_loader() {
		 ...
		 */
		require_once LSX_TO_PATH . 'dist/init.php';
	}
}
