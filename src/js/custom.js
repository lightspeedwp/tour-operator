...
(function ($, window, document, undefined) {
    ...
    lsx_to.set_read_more = function () {
        ...
        $(
            '.tax-travel-style .wp-block-read-more, .tax-accommodation-brand .wp-block-read-more, .tax-accommodation-type .wp-block-read-more'
        ).each(function () {
            if (
                0 <
                $(this).parents('.wp-block-post-content.term-description')
                    .length
            ) {
                console.log(this);
                lsx_to.readMoreText = $(this)
                ...
                $(this)
                    .parents('.wp-block-post-content.term-description')
                    .attr('data-readmore-index', pIndex);
                ...
                const newMore = $('.wp-block-post-content.term-description')
                    .find('.wp-block-read-more')
                    .last();
            ...
            if (
                ...
                if ($(this).hasClass('less-link')) {
                    lsx_to.readMoreSet(
                        $(this),
                        $(this).parents(
                            '.wp-block-post-content.term-description'
                        ),
                        pIndex
                    );
                } else {
    ...
    lsx_to.refresh_slick_in = function (root = document) {
        ...
        const $sliders = $root.is('.slick-initialized')
            ? $root
        ...
        $document.on(
            ...
            function () {
                const wrapper = $(this).closest(
                    '.lsx-to-sticky-menu-section-wrapper'
                );
