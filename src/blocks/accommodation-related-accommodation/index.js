...
function registerAccommodationRelatedAccommodationVariation() {
    wp.blocks.registerBlockVariation('core/group', {
        ...
        description: __(
            'Displays other accommodation in the area.',
            'tour-operator'
        ),
                    ...
                    [
                        ...
                        [
                            [
                                ...
                                {
                                    className:
                                        'lsx-accommodation-related-accommodation-query',
                                    layout: {
                                        type: 'grid',
                                        columnCount: 3,
                                    },
                                    ...
                                    innerBlocks: [
                                        {
                                            ...
                                            innerBlocks: [
                                                ...
                                                },
                                                {
                                                    ...
                                                    attributes: {
                                                        content: __(
                                                            'Experience luxury in the heart of the Serengeti. Our lodge offers stunning views of the African wilderness with world-class amenities and service.',
                                                            'tour-operator'
                                                        ),
                                                        style: {
                                                            spacing: {
                                    ...
                                    innerBlocks: [
                                        {
                                            ...
                                            innerBlocks: [
                                                ...
                                                },
                                                {
                                                    ...
                                                    attributes: {
                                                        content: __(
                                                            'Comfortable accommodation with breathtaking views of Mount Kilimanjaro. Perfect base for trekking adventures and exploring the region.',
                                                            'tour-operator'
                                                        ),
                                                        style: {
                                                            spacing: {
                                    ...
                                    innerBlocks: [
                                        {
                                            ...
                                            innerBlocks: [
                                                ...
                                                },
                                                {
                                                    ...
                                                    attributes: {
                                                        content: __(
                                                            'Beachfront resort on the pristine shores of Zanzibar. Enjoy crystal clear waters, white sand beaches, and authentic Swahili culture.',
                                                            'tour-operator'
                                                        ),
                                                        style: {
                                                            spacing: {
        ...
        isActive: (blockAttributes) => {
            return (
                blockAttributes.className ===
                    'lsx-accommodation-related-accommodation-query-wrapper' ||
                (blockAttributes.className &&
