/**
 * Suggested Visitor Types Block Variation
 *
 * Registers a block variation for displaying suggested visitor types.
...
wp.domReady(() => {
    ...
    const registerSuggestedVisitorTypesVariation = () => {
        wp.blocks.registerBlockVariation('core/group', {
            ...
            keywords: [
                __('visitor', 'tour-operator'),
                __('types', 'tour-operator'),
                __('guests', 'tour-operator'),
            ...
            innerBlocks: [
                ...
                [
                    ...
                    {
                        metadata: {
                            name: __('Visitor Types Content', 'tour-operator'),
                        },
                        layout: {
                            type: 'flex',
                            flexWrap: 'nowrap',
