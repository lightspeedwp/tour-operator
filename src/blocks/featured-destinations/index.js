...
wp.domReady(() => {
    wp.blocks.registerBlockVariation('core/group', {
        ...
        icon: 'admin-site',
        description: __(
            'Displays Destinations with Featured tag.',
            'tour-operator'
        ),
                    ...
                    [
                        ...
                        [
                            [
                                ...
                                {
                                    className:
                                        'lsx-featured-destinations-query',
                                    layout: {
                                        type: 'grid',
                                        columnCount: 3,
                                    },
                            ...
                            innerBlocks: [
                                {
                                    ...
                                    innerBlocks: [
                                        ...
                                        },
                                        {
                                            ...
                                            attributes: {
                                                content:
                                                    'Explore the Emilia Romagna countryside with its charming villages, delicious cuisine, and rich history.',
                                            },
                                        },
                                    ],
                                },
