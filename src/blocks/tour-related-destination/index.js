						...
						[
							...
							[
								[
									...
									[
										["core/heading", { content: "Cape Town, South Africa", level: 3 }],
										[
											"core/paragraph",
											{
												content:
													"Stunning coastal city with Table Mountain, beautiful beaches, and rich cultural heritage.",
											},
										],
									],
								],
								[
									...
									[
										["core/heading", { content: "Serengeti National Park", level: 3 }],
										[
											"core/paragraph",
											{
												content:
													"World-renowned wildlife sanctuary famous for the Great Migration and Big Five game viewing.",
											},
										],
									],
								],
								[
									...
									[
										["core/heading", { content: "Victoria Falls", level: 3 }],
										[
											"core/paragraph",
											{
												content:
													"One of the world's largest waterfalls offering breathtaking views and adventure activities.",
											},
										],
									],
								],
