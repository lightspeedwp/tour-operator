...
wp.domReady(() => {
    ...
    const registerSpecialInterestsVariation = () => {
        wp.blocks.registerBlockVariation('core/group', {
            ...
            description: __('Display special interests and activities for accommodations.', 'tour-operator'),
            icon: wp.element.createElement(
                ...
                wp.element.createElement('g', { 'clip-path': 'url(#clip0_10031_118612)' },
                ...
                wp.element.createElement('defs', null,
                    wp.element.createElement('clipPath', { id: 'clip0_10031_118612' },
            ...
            keywords: [
                __('special', 'tour-operator'),
                __('interests', 'tour-operator'),
                __('activities', 'tour-operator'),
                __('features', 'tour-operator'),
            ],
            ...
            innerBlocks: [
                ...
                [
                    ...
                    {
                        metadata: {
                            name: __('Interests Content', 'tour-operator'),
                        },
                        layout: {
                            type: 'flex',
                            flexWrap: 'nowrap',
                        ...
                        innerBlocks: [
                            {
                                name: 'core/paragraph',
                                attributes: {
                                    content: __('Wildlife viewing, Photography, Cultural experiences, Adventure activities', 'tour-operator'),
                                },
                            },
                        ],
                    },
