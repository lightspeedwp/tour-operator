...
const Inspector = (props) => {
    ...
    return (
        <>
            <InspectorControls>
                <PanelBody
                    title={__('Offset Settings', 'tour-operator')}
                    initialOpen={false}
                >
                    <TextControl
                        label={__('Sticky Header Selector', 'tour-operator')}
                        help={__(
                            'CSS selector for an additional sticky header whose height should be accounted for (e.g. #site-header, .my-sticky-bar).',
                            'tour-operator'
                        )}
                        value={stickyOffsetSelector || ''}
                        onChange={(value) =>
                            setAttributes({ stickyOffsetSelector: value })
                        }
                    ...
                    settings={[
                        {
                            ...
                            colorValue:
                                ...
                                (activeBackgroundColor
                                    ...
                                    : undefined),
                            onColorChange: createColorChangeHandler(
                                'activeBackgroundColor',
                                'customActiveBackgroundColor'
                            ),
                        },
