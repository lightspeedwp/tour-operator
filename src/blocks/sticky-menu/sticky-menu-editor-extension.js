                ...
                <InspectorControls>
                    ...
                    >
                        <ToggleControl
                            ...
                            help={__(
                                'Include this section in the sticky navigation menu. ID and title will be taken from block settings.',
                                'tour-operator'
                            )}
                        ...
                        {addToStickyMenu && (
                            <Fragment>
                                ...
                                >
                                    {__(
                                        'ID and Title are automatically taken from:',
                                        'tour-operator'
                                    )}
                                </p>
                                <ul
                                ...
                                >
                                    <li>
                                        {__(
                                            'HTML Anchor (Block Settings → Advanced)',
                                            'tour-operator'
                                        )}
                                    </li>
                                    <li>
                                        {__(
                                            'Block Name (rename in List View or toolbar)',
                                            'tour-operator'
                                        )}
                                    </li>
                                </ul>
                                ...
                                {!nativeId && (
                                    ...
                                    >
                                        {__(
                                            '⚠️ No HTML Anchor set. Go to Block Settings → Advanced to add one.',
                                            'tour-operator'
                                        )}
                                    </p>
                                )}
                                {!nativeName && (
                                    ...
                                    >
                                        {__(
                                            '⚠️ No block name set. Rename this block in the List View.',
                                            'tour-operator'
                                        )}
                                    </p>
                                )}
...
function addStickyMenuSaveProps(extraProps, blockType, attributes) {
    ...
    if (addToStickyMenu && sectionId) {
        ...
        extraProps.className =
            `${existingClass} lsx-to-sticky-menu-section`.trim();
    }
...
const withStickyMenuEditor = createHigherOrderComponent((BlockListBlock) => {
    return (props) => {
        ...
        const shouldShowIndicator =
            hasStickyMenuBlock && addToStickyMenu && sectionId;
        ...
        const badge = shouldShowIndicator ? (
            ...
            >
                📌 {__('Sticky Menu Section', 'tour-operator')}:{' '}
