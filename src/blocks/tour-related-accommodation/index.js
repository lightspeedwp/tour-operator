						...
						[
							...
							[
								[
									...
									[
										["core/heading", { content: "Safari Lodge", level: 3 }],
										[
											"core/paragraph",
											{
												content:
													"Luxury safari lodge with panoramic views of the Serengeti and exceptional wildlife viewing opportunities.",
											},
										],
									],
								],
								[
									...
									[
										["core/heading", { content: "Boutique Resort", level: 3 }],
										[
											"core/paragraph",
											{
												content:
													"Intimate boutique resort offering personalized service and unique cultural experiences.",
											},
										],
									],
								],
								[
									...
									[
										["core/heading", { content: "Eco Camp", level: 3 }],
										[
											"core/paragraph",
											{
												content:
													"Sustainable eco-camp providing authentic wilderness experiences with minimal environmental impact.",
											},
										],
									],
								],
