						...
						[
							...
							[
								[
									...
									[
										["core/heading", { content: "Breathtaking Destination", level: 4 }],
										[
											"core/paragraph",
											{
												content:
													'"Absolutely stunning scenery and rich cultural experiences. This destination exceeded all expectations!" - Alexandra P.',
											},
										],
									],
								],
								[
									...
									[
										["core/heading", { content: "Incredible Adventure", level: 4 }],
										[
											"core/paragraph",
											{
												content:
													'"Perfect blend of adventure and relaxation. The local guides were fantastic and very knowledgeable." - Michael B.',
											},
										],
									],
								],
								[
									...
									[
										["core/heading", { content: "Must-Visit Location", level: 4 }],
										[
											"core/paragraph",
											{
												content:
													'"A truly magical place with so much to see and do. We can\'t wait to return to explore more!" - Lisa and James H.',
											},
										],
									],
								],
