/**
 * Related Regions Block Variation
 *
 * Registers a block variation for displaying regions related to the current location.
...
wp.domReady(() => {
    const registerRelatedRegionsBlock = () => {
        wp.blocks.registerBlockVariation('core/group', {
            ...
            description: __(
                'Displays any regions from the parent country.',
                'tour-operator'
            ),
                ...
                [
                    ...
                    [
                        ...
                        [
                            ...
                            {
                                textAlign: 'center',
                                content: __('Related Regions', 'tour-operator'),
                            },
                        ],
                        [
                            'core/separator',
                                ...
                                innerBlocks: [
                                    {
                                        ...
                                        innerBlocks: [
                                            ...
                                            },
                                            {
                                                ...
                                                attributes: {
                                                    content: __(
                                                        'Explore the stunning landscapes and wildlife of the northern regions.',
                                                        'tour-operator'
                                                    ),
                                                },
                                            },
                                    ...
                                    },
                                    {
                                        ...
                                        innerBlocks: [
                                            ...
                                            },
                                            {
                                                ...
                                                attributes: {
                                                    content: __(
                                                        'Discover pristine beaches and vibrant coastal communities.',
                                                        'tour-operator'
                                                    ),
                                                },
                                            },
