	...
	public function create_settings_page(){
		if(is_admin()){
			if(!class_exists('\lsx\ui\uix')){
				include_once $this->framework_path.'uix/uix.php';
			}
	...
	public function settings_page_array(){
		...
		$tabs = array( // tabs array are for setting the tab / section templates
				...
				'general'		=> array(
						...
						'page_description'  => '',
						'menu_title'        => 'General',
						'template'          => $this->framework_path.'includes/settings/general.php',
						'default'	 		=> true
				)
		);
		...
		if(false === $posts_page){
			$tabs['post'] = array(
				...
				'page_description'  => '',
				'menu_title'        => 'Posts',
				'template'          => $this->framework_path.'includes/settings/post.php',
				'default'	 		=> false
			);
		}
