...
!jQuery(function (a) {
    ...
    conduitException = function (a) {
        ...
        var c = a.modal.split("."), d = a.app ? a.app : a.trigger.closest("[data-app]").data("app"),
            ...
            f = Handlebars.compile('<div data-app="' + a.template + '">{{> ' + a.template + "}}</div>", {data: !0});
        ...
        b.preventDefault();
        var c, d = a(this), e = a(this).data("saveObject"), f = a(".page-title-action .spinner"), g = a(".uix-sub-nav");
        a(".uix-notice .notice-dismiss").trigger("click"), c = !0 === e ? conduitPrepObject() : conduitPrepObject(e), d.addClass("saving"), f.slideDown(100);
        var h = {
            action: uix.slug + "_save_config",
            uix_setup: a("#uix_setup").val(),
            page_slug: uix.page_slug,
        ...
        uix.save_params && (h.params = uix.save_params), a.post(ajaxurl, h, function (b) {
            f.slideUp(100), d.removeClass("saving");
