<?php
/**
 * Title: archive-travel-style
 * Slug: lsx-tour-operator/archive-travel-style
 * Inserter: no
 */
?>
...
<!-- wp:group {"metadata":{"name":"Breadcrumbs"},"align":"full","style":{"spacing":{"padding":{"top":"6px","bottom":"6px","left":"var:preset|spacing|x-small","right":"var:preset|spacing|x-small"}},"elements":{"link":{":hover":{"color":{"text":"var:preset|color|tertiary"}},"color":{"text":"var:preset|color|base"}}}},"backgroundColor":"primary-900","textColor":"base","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull has-base-color has-primary-900-background-color has-text-color has-background has-link-color" style="padding-top:6px;padding-right:var(--wp--preset--spacing--x-small);padding-bottom:6px;padding-left:var(--wp--preset--spacing--x-small)"><!-- wp:group {"align":"wide","layout":{"type":"default"}} -->
...
<div class="wp-block-group alignwide"><!-- wp:term-description {"textAlign":"center","align":"wide","fontSize":"small"} /--></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<figure class="wp-block-image size-large"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/from-price-TO-icon-black-20px.png" alt="" style="object-fit:cover"/></figure>
<!-- /wp:image -->
...
<!-- wp:paragraph {"metadata":{"name":"Price"},"style":{"spacing":{"padding":{"top":"2px","bottom":"2px"}}}} -->
...
<figure class="wp-block-image size-large"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/accommodation-type-TO-icon-black-20px.png" alt="" style="object-fit:cover"/></figure>
<!-- /wp:image -->
...
<!-- wp:paragraph {"metadata":{"name":"Number of Rooms"},"style":{"spacing":{"padding":{"top":"2px","bottom":"2px"}}}} -->
...
<p class="has-text-align-center">Unfortunately, there are no travel styles listed at the moment. Please check back soon as we regularly update our offerings.</p>
<!-- /wp:paragraph -->
<!-- /wp:query-no-results -->
...
<!-- wp:template-part {"slug":"footer-2-0"} /-->