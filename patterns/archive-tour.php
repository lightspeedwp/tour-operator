...
/**
 * Title: archive-tour
 * Slug: lsx-tour-operator/archive-tour
 * Inserter: no
 */
?>
...
<div class="wp-block-group center-vertically" style="min-height:3rem;padding-top:5px"><!-- wp:post-title {"textAlign":"center","isLink":true,"style":{"spacing":{"padding":{"top":"0","bottom":"0"},"margin":{"top":"0","bottom":"0"}}},"fontSize":"small"} /-->

<!-- wp:paragraph {"align":"center","metadata":{"bindings":{"content":{"source":"core/post-meta","args":{"key":"tagline"}}}}} -->
<p class="has-text-align-center">hh</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
