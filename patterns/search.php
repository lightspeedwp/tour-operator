...
<figure class="wp-block-image size-large is-resized"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/Typetype-icon.png" alt="" style="width:20px;height:auto"/></figure>
<!-- /wp:image -->
