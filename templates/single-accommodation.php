		...
		<section class="accommodation-navigation">
			<div class="container">
				<ul class="scroll-easing">
					<li><a href="#summary"><?php _e('Summary','lsx-tour-operators');?></a></li>
					...
					?>
						<li><a href="#facilities"><?php _e('Facilities','lsx-tour-operators');?></a></li>
					<?php } ?>					
					<?php if(lsx_has_map()){ ?>					
						<li><a href="#accommodation-map"><?php _e('Map','lsx-tour-operators');?></a></li>
					<?php } ?>
					<?php 
					...
					<?php } ?>	
					<li><a href="#related-accommodation"><?php _e('Accommodation','lsx-tour-operators');?></a></li>
					<?php
						...
						if(post_type_exists('tour') && is_array($connected_tours) && !empty($connected_tours) ) {
							?>					
							<li><a href="#related-tours"><?php _e('Tours','lsx-tour-operators');?></a></li>
						<?php
					} ?>										
				</ul>
			</div>
