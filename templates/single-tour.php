...
<div class="wp-block-group"><!-- wp:image {"width":"20px","sizeSlug":"large"} -->
<figure class="wp-block-image size-large is-resized"><img src="https://tour-operator.lsx.design/wp-content/uploads/2024/09/duration-TO-black-20px-icon.png" alt="" style="width:20px"/></figure>
<!-- /wp:image -->
...
<div class="wp-block-group"><!-- wp:image {"width":"20px","sizeSlug":"large"} -->
<figure class="wp-block-image size-large is-resized"><img src="https://tour-operator.lsx.design/wp-content/uploads/2024/09/Typelocation-icon.png" alt="" style="width:20px"/></figure>
<!-- /wp:image -->
...
<div class="wp-block-group"><!-- wp:image {"width":"20px","sizeSlug":"large"} -->
<figure class="wp-block-image size-large is-resized"><img src="https://tour-operator.lsx.design/wp-content/uploads/2024/09/Typetype-icon.png" alt="" style="width:20px"/></figure>
<!-- /wp:image -->
...
<div class="wp-block-group"><!-- wp:image {"width":"20px","sizeSlug":"large"} -->
<figure class="wp-block-image size-large is-resized"><img src="https://tour-operator.lsx.design/wp-content/uploads/2024/09/map-TO-black-20px-icon.png" alt="" style="width:20px"/></figure>
<!-- /wp:image -->
...
<div class="wp-block-group"><!-- wp:image {"width":"20px","sizeSlug":"large"} -->
<figure class="wp-block-image size-large is-resized"><img src="https://tour-operator.lsx.design/wp-content/uploads/2024/09/best-months-to-travel-TO-icon-black-20px-1-1.png" alt="" style="width:20px"/></figure>
<!-- /wp:image -->
...
<figure class="wp-block-image alignfull size-large"><img src="https://tour-operator.lsx.design/wp-content/uploads/2024/09/wetu-map-figme-prototype-image.png" alt=""/></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->
...
<div class="wp-block-group has-primary-bg-background-color has-background" style="border-radius:8px;margin-top:0;margin-bottom:0;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px"><!-- wp:image {"id":2981,"aspectRatio":"3/2","scale":"cover","sizeSlug":"full","linkDestination":"none","className":"itinerary-image","style":{"border":{"radius":"8px"}}} -->
<figure class="wp-block-image size-full has-custom-border itinerary-image"><img src="https://beta.local/wp-content/uploads/2024/09/R0I3460.jpg" alt="" class="wp-image-2981" style="border-radius:8px;aspect-ratio:3/2;object-fit:cover" title=""/></figure>
<!-- /wp:image -->
...
<figure class="wp-block-image aligncenter size-large"><img src="https://tour-operator.lsx.design/wp-content/uploads/2024/09/review-testominal-quote-mark-TO-tertiary-32px.png" alt=""/></figure>
<!-- /wp:image -->
