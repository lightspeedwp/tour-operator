...
<article id="term-<?php echo esc_attr( $term->term_id ); ?>" class="term-<?php echo esc_attr( $term->term_id ); ?> <?php echo esc_attr( $taxonomy ); ?> type-<?php echo esc_attr( $taxonomy ); ?> status-publish hentry">
	...
	<div class="lsx-to-widget-content">
		<h4 class="lsx-to-widget-title text-center"><a href="<?php echo $title_link; ?>"><?php echo esc_html( apply_filters( 'the_title', $term->name ) ); ?></a></h4>

		<p>
			<a href="<?php echo $title_link; ?>" class="moretag"><?php esc_html_e( 'View accommodation', 'tour-operator' ); ?></a>
		</p>
	</div>
</article>
