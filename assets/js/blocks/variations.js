wp.domReady(() => {
	...
	wp.blocks.registerBlockVariation("core/group", {
	  ...
	  category: "lsx-tour-operator",
	  attributes: {
		metadata: { name: "Single Supplement" },
	...
	wp.blocks.registerBlockVariation("core/group", {
	  ...
	  category: "lsx-tour-operator",
	  attributes: {
		metadata: { name: "Booking Validity" },
	...
	wp.blocks.registerBlockVariation("core/group", {
	  ...
	  category: "lsx-tour-operator",
	  attributes: {
		metadata: { name: "Best Time to Visit" },
	  ...
	  innerBlocks: [
		...
		[
		  "core/paragraph",
		  {
			...
			className:
			  "has-septenary-color has-text-color has-link-color has-primary-700-color",
			style: {
			  elements: {
				link: {
				  color: {
		  ...
		  [
			[
			  "core/paragraph",
			  {
				...
				className:
				  "has-septenary-color has-text-color has-link-color has-primary-color has-primary-700-color",
				style: {
				  spacing: {
					padding: {
					  top: "2px",
	...
	wp.blocks.registerBlockVariation("core/group", {
	  ...
	  category: "lsx-tour-operator",
	  attributes: {
		metadata: { name: "Minimum Child Age" },
	...
	wp.blocks.registerBlockVariation("core/group", {
	  ...
	  category: "lsx-tour-operator",
	  attributes: {
		metadata: { name: "Destination to Accommodation" },
	...
	wp.blocks.registerBlockVariation("core/group", {
	  ...
	  category: "lsx-tour-operator",
	  attributes: {
		metadata: { name: "Spoken Languages" },
	...
	wp.blocks.registerBlockVariation("core/group", {
	  ...
	  category: "lsx-tour-operator",
	  attributes: {
		metadata: { name: "Accommodation Type" },
	...
	wp.blocks.registerBlockVariation("core/group", {
	  ...
	  category: "lsx-tour-operator",
	  attributes: {
		metadata: { name: "Suggested Visitor Types (Friendly)" },
	...
	wp.blocks.registerBlockVariation("core/group", {
	  ...
	  category: "lsx-tour-operator",
	  attributes: {
		metadata: { name: "Special Interests" },
	...
	wp.blocks.registerBlockVariation("core/group", {
	  ...
	  title: "Travel Information - Additional Information",
	  category: "lsx-tour-operator",
	  attributes: {
		metadata: { name: "Travel Information - Additional Information" },
	...
	wp.blocks.registerBlockVariation("core/group", {
	  ...
	  title: "Travel Information - Electricity",
	  category: "lsx-tour-operator",
	  attributes: {
		metadata: { name: "Travel Information - Electricity" },
	...
	wp.blocks.registerBlockVariation("core/group", {
	  ...
	  title: "Travel Information - Banking",
	  category: "lsx-tour-operator",
	  attributes: {
		metadata: { name: "Travel Information - Banking" },
	...
	wp.blocks.registerBlockVariation("core/group", {
	  ...
	  title: "Travel Information - Cuisine",
	  category: "lsx-tour-operator",
	  attributes: {
		metadata: { name: "Travel Information - Cuisine" },
	...
	wp.blocks.registerBlockVariation("core/group", {
	  ...
	  title: "Travel Information - Climate",
	  category: "lsx-tour-operator",
	  attributes: {
		metadata: { name: "Travel Information - Climate" },
	...
	wp.blocks.registerBlockVariation("core/group", {
	  ...
	  title: "Travel Information - Transport",
	  category: "lsx-tour-operator",
	  attributes: {
		metadata: { name: "Travel Information - Transport" },
	...
	wp.blocks.registerBlockVariation("core/group", {
	  ...
	  title: "Travel Information - Dress",
	  category: "lsx-tour-operator",
	  attributes: {
		metadata: { name: "Travel Information - Dress" },
	...
	wp.blocks.registerBlockVariation("core/group", {
	  ...
	  title: "Travel Information - Health",
	  category: "lsx-tour-operator",
	  attributes: {
		metadata: { name: "Travel Information - Health" },
	...
	wp.blocks.registerBlockVariation("core/group", {
	  name: "lsx-safety-wrapper",
	  title: "Travel Information - Safety",
	  category: "lsx-tour-operator",
	  attributes: {
		metadata: { name: "Travel Information - Safety" },
  
		className:
		  "lsx-safety-wrapper is-style-shadow-xsm has-base-background-color has-background",
		style: {
		  border: {
			radius: "8px",
		  },
			  ...
			  [
				[
				  "core/paragraph",
				  {
					content: "View More",
					className:
					  "has-primary-background-color has-background wp-element-button",
					style: {
					  border: {
	...
	wp.blocks.registerBlockVariation("core/group", {
	  name: "lsx-visa-wrapper",
	  title: "Travel Information - Visa",
	  category: "lsx-tour-operator",
	  attributes: {
		metadata: { name: "Travel Information - Visa" },
  
		className:
		  "lsx-visa-wrapper is-style-shadow-xsm has-base-background-color has-background",
		style: {
		  border: {
			radius: "8px",
		  },
