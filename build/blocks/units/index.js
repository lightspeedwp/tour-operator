...
wp.domReady(() => {
  const registerUnitsVariation = () => {
    wp.blocks.registerBlockVariation('core/group', {
      ...
      title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Units', 'tour-operator'),
      icon: 'admin-multisite',
      category: 'lsx-tour-operator',
      description: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Displays all the unit (rooms/camps) types for this accommodation', 'tour-operator'),
      isActive: (blockAttributes, variationAttributes) => {
        return blockAttributes.className === variationAttributes.className;
      },
      keywords: [(0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('units', 'tour-operator'), (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('rooms', 'tour-operator'), (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('camps', 'tour-operator')],
      attributes: {
        metadata: {
          name: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Units', 'tour-operator')
        },
        align: 'wide',
        layout: {
          type: 'constrained'
      ...
      innerBlocks: [['core/group', {
        ...
        textAlign: 'center',
        content: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Units', 'tour-operator')
      }], ['core/separator', {
        style: {
          layout: {
            selfStretch: 'fill',
        ...
        align: 'wide',
        metadata: {
          name: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Accommodation Units', 'tour-operator'),
          bindings: {
            content: {
        ...
        innerBlocks: [{
          ...
          innerBlocks: [{
            ...
            innerBlocks: [{
              ...
              attributes: {
                level: 3,
                content: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Double Room', 'tour-operator')
              }
            }, {
              name: 'core/separator'
            }, {
              name: 'core/paragraph',
              attributes: {
                content: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Comfortable room with amenities', 'tour-operator')
              }
            }]
          }, {
            name: 'core/group',
            innerBlocks: [{
              name: 'core/paragraph',
              attributes: {
                content: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('From:', 'tour-operator')
              }
            }, {
              name: 'core/paragraph',
              attributes: {
                content: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('$150', 'tour-operator')
              }
            }]
          }, {
            name: 'core/image',
            ...
            innerBlocks: [{
              ...
              attributes: {
                level: 3,
                content: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('King Room', 'tour-operator')
              }
            }, {
              name: 'core/separator'
            }, {
              name: 'core/paragraph',
              attributes: {
                content: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Luxury room with premium features', 'tour-operator')
              }
            }]
          }, {
            name: 'core/group',
            innerBlocks: [{
              ...
              name: 'core/paragraph',
              attributes: {
                content: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('$250', 'tour-operator')
              }
            }]
          }]
        }]
  ...
  const conditionalRegister = (0,_js_conditional_block_registration_js__WEBPACK_IMPORTED_MODULE_1__.registerForPostTypesAndTemplates)(['accommodation'],
