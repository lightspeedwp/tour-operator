  ...
  wp.blocks.registerBlockVariation('core/group', {
    ...
    example: {
      ...
      innerBlocks: [['core/group', {}, [['core/heading', {
        ...
        content: __("Embark on an unforgettable 7-day safari experience through Kenya's most spectacular wildlife reserves.", 'tour-operator')
      }]]], ['core/group', {
        style: {
          border: {
            width: '1px',
        ...
        content: __('European Cultural Journey', 'tour-operator'),
        level: 3
      }], ['core/paragraph', {
        content: __('Discover the rich history and culture of Europe with visits to iconic cities and historic landmarks.', 'tour-operator')
      }]]], ['core/group', {
        style: {
          border: {
            width: '1px',
        ...
        content: __('Tropical Island Escape', 'tour-operator'),
        level: 3
      }], ['core/paragraph', {
        content: __('Relax and unwind on pristine beaches with crystal clear waters and vibrant coral reefs.', 'tour-operator')
      }]]]]]]]]
    }
  });
});
